...
export const sendResetPasswordMail = ({
  ...
  sendMail({
    from: "bdlord@no-reply.com",
    to: email,
    text: "This is reset password mail from Bdlord. This link will expire in 10 Minutes. Please Do Not Reply To This Email.",
...
<html>
  ...
  <body style="background-color: #e9ecef">
    <div
      ...
      "
    >
      Reset Password Mail From BDLord This Will Expire In 10 Minutes
    </div>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td align="center" bgcolor="#e9ecef">
        ...
        <td align="center" bgcolor="#e9ecef">
          ...
          >
            <tr>
              ...
              >
                <p style="margin: 0">
                  Tap the button below to change your password. The Link Will Expire In 10 Minutes
                </p>
              </td>
            </tr>
            <tr>
